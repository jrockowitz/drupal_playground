# ClinicalTrials.gov Fields Elastic Recipe

Sets up a ClinicalTrials.gov data search experience backed by Elasticsearch for the `trial` content type created by the `clinical_trials_gov_recipe_fields_setup` recipe.
