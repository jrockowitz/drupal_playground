...
/**
 * Blocks manual creation of the ClinicalTrials.gov bundle when Trash is active.
 */
class ClinicalTrialsGovTrashNodeAccessControlHandler extends TrashNodeAccessControlHandler {
