...
#[SearchApiAutocompleteSuggester(
  id: 'clinical_trials_gov_data_search_api_autocomplete',
...
class ClinicalTrialsGovDataSearchApiAutocomplete extends SuggesterPluginBase {

  /**
   * Constructs a new ClinicalTrials.gov data autocomplete suggester.
   */
